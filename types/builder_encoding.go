...
// Hash: eb3191ed4c2ac48671d59eecb07e5e43b063b6d2e1e69af5eafbc9a5eda09751
// Version: 0.1.3
package types
...
func (r *RegisterValidatorRequestMessage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (4) 'ProposerCommitment'
	dst = ssz.MarshalUint64(dst, r.ProposerCommitment)
...
func (r *RegisterValidatorRequestMessage) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'ProposerCommitment'
	r.ProposerCommitment = ssz.UnmarshallUint64(buf[84:92])
...
func (r *RegisterValidatorRequestMessage) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (4) 'ProposerCommitment'
	hh.PutUint64(r.ProposerCommitment)
